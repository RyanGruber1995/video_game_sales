...
For a full list of queries that were ran please refer to the [SQL_Queries.sql](https://github.com/RyanGruber1995/video_game_sales/blob/main/SQL_Queries.sql) file.
